const ports = {
    backendPort: process.env.NODE_ENV === 'production' ? 3001 : 3333,
    frontendPort: process.env.NODE_ENV === 'production' ? 28450 : 3000,
};

export const constants = {
    ...ports,
    backendBaseURL: process.env.NODE_ENV === 'production' ? 'https://chat.stickz.dev' : `http://localhost:${ports.backendPort}`,
    frontendBaseURL: process.env.NODE_ENV === 'production' ? 'https://chat.stickz.dev' : `http://localhost:${ports.frontendPort}`,
    svgs: {
        icons: {
